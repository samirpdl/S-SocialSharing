        ...
        if (error) {
            ...
            if (self.threeLeggedOAuthCallback) {
                if (statusCode == 200) {
                    ...
                    NSLog(@"%@", responseParameters);
                    
                    
                    [[NSUserDefaults standardUserDefaults] setObject:responseParameters[@"oauth_token"] forKey:@"tumblr_oauth_token"];
                    [[NSUserDefaults standardUserDefaults] setObject:responseParameters[@"oauth_token_secret"] forKey:@"tumblr_oauth_token_secret"];
                    [[NSUserDefaults standardUserDefaults] synchronize];
                    
                    [[NSNotificationCenter defaultCenter] postNotificationName:@"tumblr-authorized" object:self];
